...
public class ExplosionScript : MonoBehaviour 
{
	...
	public float expansionTickRate;
    ...
    {                                                
            ...
            //collisionInfo.impactForceSum.magnitude > targetThresh)
		{
            ...
            // Destroy(gameObject);
			// Instead of being destroyed on hit, the explosion continues to expand in-place, always destroying itself after a set time.
        }
    ...
    {
        /*original*/ // yield return new WaitForSeconds(1f);
		yield return new WaitForSeconds(0.25f);
        
        Destroy(gameObject);
    }

	// Unused, was attepting to fix an error that actually was unrelated
	/*
	private IEnumerator Explode()
	{
		yield return new WaitForSeconds(0.0f);
		InvokeRepeating("Expand", 0f, expansionTickRate * 1f);
	}
	*/
    ...
    private IEnumerator Expand()
    {
		while (true)
		{
			...
			yield return new WaitForSeconds(expansionTickRate * 1f);
		}
    }
}
